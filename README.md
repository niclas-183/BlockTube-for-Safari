...
- Full Xcode (not just Command Line Tools) — available free on the [Mac App Store](https://apps.apple.com/app/xcode/id497799835?mt=12). Verify with `xcode-select -p` — it should point to `/Applications/Xcode.app`. If it doesn't, run:
  ```
